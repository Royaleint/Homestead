...
- **Type:** Feature
- **Priority:** Medium
- **Status:** Backlog — plan Revision 3 ready for Douglock (`Home_Dev/plans/active/HS-018-source-aware-map-filtering.md` @ Home_Dev `47e3181`). Gate 3 closed 2026-05-10; Rawb code review + re-review gaps addressed in Revision 3. Implementation dispatched to Douglock 2026-05-10.
