...
- **Type:** Feature
- **Priority:** Medium
- **Status:** Backlog — plan ready for Douglock (`Home_Dev/plans/active/HS-018-source-aware-map-filtering.md` @ Home_Dev `ee0f8b6`). Gate 3 closed 2026-05-10. Next action: Douglock creates worktree `feature/source-aware-map-filtering`, implements 3 commits in order.
