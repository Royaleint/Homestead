...
- **Status:** Origin A — **Done**, merged `3d55565`, in-game confirmed, Argus PASS, pushed. Origin B — **In Progress** (2026-05-12): plan `Home_Dev/plans/active/HS-081-mapsidepanel-ticker.md` (`e7812b9`) + Claude Code plan approved; implemented on worktree branch `refactor/hs081-mapsidepanel-ticker` (commits `9437d21` + `41d2a2c`, pushed); Argus Gate 1 **PASS**; **awaiting Gate 2** (Rawb in-game).
- **GitHub:** [#38](https://github.com/Royaleint/Homestead/issues/38) — left **open** to track origin B.
